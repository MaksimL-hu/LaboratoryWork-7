...
---
# Сравнение точности (в первом варианте точность 93.33%, а во втором 100%)
...
В первом варианте программа работала с готовым входным BMP-изображением. На таком изображении возможны особенности скриншота, сглаживания, толщины линий, положения символа, сегментации и размер шрифта. Поэтому один символ, `И`, был спутан с `К`.
